...
export default function ThankYou() {
  ...
  // Check if order is paid return order data
      ...
      <div className='mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8'>
        ...
        <div className='max-w-xl'>
          ...
          <p className='mt-2 text-base text-zinc-500'>
            We&rsquo;ve received your order and are now processing it.
          </p>
        ...
        <div className='mt-10 border-t border-zinc-200'>
          <div className='mt-10 flex flex-auto flex-col'>
            ...
            <p className='mt-2 text-sm text-zinc-600'>
              We at CaseCobra believe that a phone doesn&rsquo;t only need to
              look good, but also last you for the years to come. We offer a
              5-year print guarantee: If your case is not of the hightest
              quality, we will replace it for free.
            </p>
          </div>
        </div>
